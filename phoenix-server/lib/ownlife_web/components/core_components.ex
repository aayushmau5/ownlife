defmodule OwnlifeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OwnlifeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OwnlifeWeb.Gettext, "errors", msg, opts)
    end
  end
